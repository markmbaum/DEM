function [xn,yn,rn] = newtonRightEdge(xn,yn,rn,xp,yp,rp,xu,yu,ru,tol)
%newtonLeftEdge uses generalized Newton's method to adjust the position and
%size of an element being placed along the right edge.
%   [xn,yn,rn] = newtonRightEdge(xn,yn,rn,xp,yp,rp,xu,yu,ru,tol)
%
