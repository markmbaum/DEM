function [xn,yn,rn] = bisectionTopEdge(~,~,rn,xp,yp,rp,xu,yu,ru,tol)
%bisectionTopEdge uses a bisection root finding method to improve the
%position of an element placed on the top edge that overlaps another
%element.
%   bisectionTopEdge(~,~,rn,xp,yp,rp,xu,yu,ru,tol)
%
