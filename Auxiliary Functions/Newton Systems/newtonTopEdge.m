function [xn,yn,rn] = newtonTopEdge(xn,yn,rn,xp,yp,rp,xu,yu,ru,tol)
%newtonTopEdge uses generalized Newton's method to adjust the position and
%size of an element being placed along the top edge.
